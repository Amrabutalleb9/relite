...
export function InteractiveAccordion({ items, defaultActiveId }: InteractiveAccordionProps) {
            ...
            <div key={item.id}>
              ...
              >
                <div className="flex items-center gap-6 py-6 px-1">
                  <div className="relative flex items-center justify-center w-10 h-10">
                    ...
                    />
                    <motion.span
                      className="relative z-10 text-caption font-sans tracking-wider"
                      animate={{
                        color: isActive
                  ...
                  <motion.h3
                    className="text-subheading tracking-tight"
                    animate={{
              ...
              <AnimatePresence mode="wait">
                {isActive && (
                  ...
                  >
                    <motion.p
                      className="pl-16 pr-12 py-6 text-body text-muted leading-relaxed"
                      initial={{ y: -10 }}
                      animate={{ y: 0 }}
                      exit={{ y: -10 }}
                      transition={{
